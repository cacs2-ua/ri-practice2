...
void cloudCallback(const sensor_msgs::PointCloud2ConstPtr & inputCloudMsg) {
  ...
  /*******************************************************************************************************************/
  system("exec rm -r /ignacio/Desktop/iros_2023/catkin_ws/src/GeoGraspEvo/experiments/*");
    
  pcl::io::savePCDFileASCII ("/ignacio/Desktop/iros_2023/catkin_ws/src/GeoGraspEvo/experiments/a_first.pcd", *cloud);
  ...
  ptFilter.setFilterLimits(0.0,1.5); //0.4 0.8
  ptFilter.filter(*cloud);

  ptFilter.setInputCloud(cloud);
  ptFilter.setFilterFieldName("y");
  ptFilter.setFilterLimits(-0.55, 0.40); //-0.55 0.4
  ptFilter.filter(*cloud);

  ptFilter.setInputCloud(cloud);
  ptFilter.setFilterFieldName("x");
  ptFilter.setFilterLimits(-0.50, 0.50); //-0.4 0.4
  ptFilter.filter(*cloud);
  
  
  /*******************************************************************************************************************/
  pcl::io::savePCDFileASCII ("/ignacio/Desktop/iros_2023/catkin_ws/src/GeoGraspEvo/experiments/a_second.pcd", *cloud);
  ...
  if (clusterIndices.empty()) {
    ...
    std::string cad = std::string("/ignacio/Desktop/iros_2023/catkin_ws/src/GeoGraspEvo/experiments/a_first")+".pcd";
    ...
    for (it = clusterIndices.begin(); it != clusterIndices.end(); ++it) {
      ...
      pcl::io::savePCDFileASCII ("/ignacio/Desktop/iros_2023/catkin_ws/src/GeoGraspEvo/experiments/a_third"+std::to_string(objNumber)+".pcd", *a_third);
      std::cerr << "Saved " << (*a_end).size () << " data points to "<<"a_third"<<std::to_string(objNumber)<<".pcd" << std::endl;
      
      std::string cad = std::string("/ignacio/Desktop/iros_2023/catkin_ws/src/GeoGraspEvo/experiments/b")+"_obj"+std::to_string(objNumber)+".pcd";
      ...
      geoGraspPoints.setApertures({{-0.015,-0.020}, {0.005,0.015}, {0.020,0.035}});
      ...
      if (var[0] > 0.1){
        ...
        std::string cad = std::string("/ignacio/Desktop/iros_2023/catkin_ws/src/GeoGraspEvo/experiments/b")+"_obj"+std::to_string((objNumber-1))+".pcd";
        ...
        *voxelCloud2 = *newScene;
        ...
        for(int point=0; point<var1.size(); point++){
        ...
        cad = std::string("/ignacio/Desktop/iros_2023/catkin_ws/src/GeoGraspEvo/experiments/c")+"_result"+std::to_string((objNumber-1))+".pcd";
        ...
        cad = std::string("/ignacio/Desktop/iros_2023/catkin_ws/src/GeoGraspEvo/experiments/c_resultFinal")+".pcd";
