...
void cloudCallback(const sensor_msgs::PointCloud2ConstPtr & inputCloudMsg) {
  ...
  /*******************************************************************************************************************/
  system("exec rm -r /daniel/Desktop/pruebas/*");
    
  pcl::io::savePCDFileASCII ("/daniel/Desktop/pruebas/a_first.pcd", *cloud);
  ...
  /*******************************************************************************************************************/
  pcl::io::savePCDFileASCII ("/daniel/Desktop/pruebas/a_second.pcd", *cloud);
  ...
  /*pcl::io::savePCDFileASCII ("/daniel/Desktop/pruebas/a_third.pcd", *a_third);
  ...
  if (clusterIndices.empty()) {
    ...
    std::string cad = std::string("/daniel/Desktop/pruebas/a_second")+".pcd";
    ...
    for (it = clusterIndices.begin(); it != clusterIndices.end(); ++it) {
      ...
      pcl::io::savePCDFileASCII ("/daniel/Desktop/pruebas/a_third"+std::to_string(objNumber)+".pcd", *a_third);
      std::cerr << "Saved " << (*a_end).size () << " data points to "<<"a_third"<<std::to_string(objNumber)<<".pcd" << std::endl;
      
      std::string cad = std::string("/daniel/Desktop/pruebas/b")+"_obj"+std::to_string(objNumber)+".pcd";
      ...
      /*pcl::io::savePCDFileASCII ("/daniel/Desktop/pruebas", *objectCloudXYZ);
      ...
      if (var[0] > 0.1){
        ...
        std::string cad = std::string("/daniel/Desktop/pruebas/b")+"_obj"+std::to_string((objNumber-1))+".pcd";
        ...
        *voxelCloud2 = *newScene;
        ...
        cad = std::string("/daniel/Desktop/pruebas/c")+"_result"+std::to_string((objNumber-1))+".pcd";
        ...
        cad = std::string("/daniel/Desktop/pruebas/c_resultFinal")+".pcd";
        ...
        /*std::string cad = "exec rm /daniel/Desktop/pruebas/a_third"+std::to_string((objNumber-1))+".pcd";
        system(cad.c_str());
        cad = "exec rm /daniel/Desktop/pruebas/b_obj"+std::to_string((objNumber-1))+".pcd";
        system(cad.c_str());
        cad = "exec rm /daniel/Desktop/pruebas/b_FinalCandidates"+std::to_string((objNumber-2))+"_0.pcd";
        system(cad.c_str());        
        cad = "exec rm /daniel/Desktop/pruebas/b_FinalCandidates"+std::to_string((objNumber-2))+"_1.pcd";
        system(cad.c_str());                
        cad = "exec rm /daniel/Desktop/pruebas/b_tillThumbCandidates"+std::to_string((objNumber-2))+".pcd";    
        system(cad.c_str());*/
      }
    }
